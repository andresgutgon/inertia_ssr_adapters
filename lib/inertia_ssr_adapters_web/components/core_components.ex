defmodule InertiaSsrAdaptersWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(InertiaSsrAdaptersWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(InertiaSsrAdaptersWeb.Gettext, "errors", msg, opts)
    end
  end
